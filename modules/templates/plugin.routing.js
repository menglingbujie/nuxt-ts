...
function localePath (route, locale = 'default') {
...
function localeRoute (route, locale = 'default') {
  ...
  if (strategy !== STRATEGIES.PREFIX_ALSO_DEFAULT && locale && locale === 'default') {
    return;
  }
  ...
  if (route.path && !route.name) {
    ...
    const isPrefixed =
        ...
        // no prefix for default
        !(STRATEGIES.PREFIX_ALSO_DEFAULT && locale === 'default')
...
function switchLocalePath (locale = 'default') {
  ...
  const { params, query, ...routeCopy } = route
  // omit lang
...
function getLocaleRouteName (routeName, locale = 'default') {
  ...
  if (locale === 'default' && strategy === STRATEGIES.PREFIX_ALSO_DEFAULT) {
    return routeName + routesNameSeparator + defaultLocaleRouteNameSuffix;
  }
